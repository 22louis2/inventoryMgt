package com.example.inventorymgmt.feature.item.ui.screen
...
import com.example.inventorymgmt.feature.item.ui.viewmodel.CreateItemViewModel
import com.example.inventorymgmt.feature.item.ui.viewmodel.ItemListViewModel
...
fun ItemListScreen(
    ...
    category: Category,
    navigateToProductDetail: (Int) -> Boolean
) {
                    ...
                    trailingContent = {
                        Row {
                            ...
                            Icon(
                                ...
                                modifier = Modifier
                                    .clickable {
                                        createItemViewModel.deleteItem(it)
                                    }
                            )
                        }
                    }
    ...
    BasicAlertDialog(
        ...
        Surface(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                OutlinedTextField(
                    value = createItemUiState.category,
                    onValueChange = {
                        createItemViewModel.updateItemCategory(it)
                    },
                    label = {
                        Text(text = "Category")
                    }
